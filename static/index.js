  ...
  generateHTML() {
    ...
    <div class="course-item">
      ...
      <div class="course-footer">
        ...
        <p></p>
        <img class="favourite" src="assets/star_default.png" onclick="togglefavourite('${this.url}')" onmouseover="this.src='assets/star_fill.png'" onmouseout="this.src='assets/star_default.png'" />
